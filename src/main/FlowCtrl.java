...
public class FlowCtrl {
        ...
        while (true) {
            try {
                ...
                if (choice == 1) {
                    ...
                    if(users.isEmpty()) {
                        System.out.println("No account available. Please login first."); 
                        Utils.delay(1000);
                        signUp();
                    }else login();
                } else if (choice == 3) {
    ...
    static void login() {
        ...
        User user = users.get(name); // return password
    ...
    static void predictNextCycle() {
        if (loggedInUser.getCycles().size() < 2) {
    ...
    /* */
    public static double getAverageCycleLength(User user) {
    ...
    /* */
    public static double getAverageDuration(User user) {
